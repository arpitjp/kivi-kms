...
const ICONS = {
  ...
  addRow: svg('<rect x="2" y="2" width="12" height="12" rx="1.5"/><line x1="2" y1="8" x2="14" y2="8"/><line x1="8" y1="10" x2="8" y2="14" stroke-width="1.8"/><line x1="6" y1="12" x2="10" y2="12" stroke-width="1.8"/>'),
  addCol: svg('<rect x="2" y="2" width="12" height="12" rx="1.5"/><line x1="8" y1="2" x2="8" y2="14"/><line x1="10" y1="8" x2="14" y2="8" stroke-width="1.8"/><line x1="12" y1="6" x2="12" y2="10" stroke-width="1.8"/>'),
      ...
      new Plugin({
        ...
        view() {
          ...
          function showMenu(view: EditorView, tableEl: HTMLElement) {
            ...
            menu.appendChild(btn(ICONS.addRow, 'Add row', () => editor.chain().focus().addRowAfter().run()));
            menu.appendChild(btn(ICONS.addCol, 'Add column', () => editor.chain().focus().addColumnAfter().run()));
